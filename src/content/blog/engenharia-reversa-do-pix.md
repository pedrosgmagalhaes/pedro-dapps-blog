...
<div style="display:flex;align-items:center;gap:16px;margin:28px 0;padding:18px 20px;border:1px solid #333333;border-left:3px solid #c89b52;border-radius:12px;background:rgba(255,255,255,0.04)">
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#f4f4f1" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="flex:0 0 auto"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
  <div style="font-size:16px;line-height:1.6">
    <strong style="color:#f4f4f1">Quer ver mais informações?</strong> <span style="color:#9a9a92">O código completo deste guia — o laboratório com parser BR Code, mini-DICT/mini-SPI e o blueprint da stack — está aberto no GitHub, pronto para você explorar e estudar:</span><br>
    <a href="https://github.com/pedrosgmagalhaes/pix-engenharia-reversa" style="color:#c89b52;font-weight:700;text-decoration:none">github.com/pedrosgmagalhaes/pix-engenharia-reversa</a>
  </div>
</div>
